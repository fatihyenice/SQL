...
-- - nom : SASS
-- - description : aucune
INSERT INTO `tag`(`id`, `name`, `description`) VALUES (NULL,'SASS','')
-- Exo 2.2
...
-- - date de fin : aucune
INSERT INTO `school_year`(`id`, `name`, `description`, `start_date`, `end_date`) VALUES (NULL,'Promo 2023','La promo de l\'année 2023','2023-03-15',NULL)
-- Exo 2.3
...
DELETE FROM `student_tag` WHERE student_id = 99 AND tag_id = 4
DELETE FROM `student_tag` WHERE student_id = 99 AND tag_id = 5
DELETE FROM `student_tag` WHERE student_id = 99 AND tag_id = 7
DELETE FROM `student_tag` WHERE student_id = 99 AND tag_id = 8
-- Exo 2.9
